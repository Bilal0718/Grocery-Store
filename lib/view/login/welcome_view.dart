...
import 'package:grocery_store/common_widget/round_button.dart';
import 'package:grocery_store/view/login/sign_in_view.dart';
...
class _WelcomeViewState extends State<WelcomeView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          Image.asset('assets/img/welcom_bg.png',
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text("Get your groceries in as fast as one hour",style: TextStyle(color: const Color(0xffFCFCFC).withOpacity(0.7),fontSize: 16,fontWeight:FontWeight.w500),
                        ),
                      ],
                    ),
